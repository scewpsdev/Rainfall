...
internal class Action
{
	...
	public Action(ActionType type, string name, ActionPriority priority = ActionPriority.Normal)
	{
		this.type = type;
		this.name = name;
	...
	{
		get => startTime > 0 ? (Time.currentTime - startTime) / 1e9f / animationSpeed : 0.0f;
	}
}
