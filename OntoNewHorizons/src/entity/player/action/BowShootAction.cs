...
internal class BowShootAction : Action
{
	...
	public BowShootAction(Item bow, int handID)
		: base(ActionType.BowShoot, "bow_shoot")
	{
		this.bow = bow;
		this.handID = handID;
	...
	public override void onStarted(Player player)
	{
		...
		OntoNewHorizons.instance.world.addEntity(new Arrow(Item.Get("arrow"), bow, player, arrowDirection, offset), arrowPosition, arrowRotation);
