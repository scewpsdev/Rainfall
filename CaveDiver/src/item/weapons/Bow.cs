...
public class Bow : Weapon
{
	...
	public override bool useSecondary(Player player)
	{
		...
		player.actions.queueAction(new AttackAction(this, player.handItem == this, anim, attackIdx, 2, 0.5f * getAttackDamage(player), 1, startAngle, endAngle) { swingDir = swingDir, useSoundPlayed = true });
		return false;
	}
}
