...
public class CaveDiver : Game
{
	...
	public static new CaveDiver instance { get => (CaveDiver)Game.instance; }
	static readonly string ASSEMBLY_NAME = Assembly.GetAssembly(typeof(CaveDiver))?.GetName().Name;
	...
	{
		Display.windowTitle = "Cave Diver";
