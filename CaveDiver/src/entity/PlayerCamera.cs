...
public class PlayerCamera : Entity
{
	...
	{
		width = CaveDiver.instance.width / 16.0f; // Display.width / (float)scale / 16.0f;
		height = CaveDiver.instance.height / 16.0f; // Display.height / (float)scale / 16.0f;
