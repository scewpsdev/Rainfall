...
public class HyperCartDrifter : Game
{
	...
	public static new HyperCartDrifter instance { get => (HyperCartDrifter)Game.instance; }
	static readonly string ASSEMBLY_NAME = Assembly.GetAssembly(typeof(HyperCartDrifter))?.GetName().Name;
	...
	public static void Main(string[] args)
	{
		...
		Game game = new HyperCartDrifter();
