...
public class Fountain : Entity, Interactable
{
	...
	{
		level.addEntity(particles = Effects.CreateFountainEffect(), position);
		particles.z = 1.0f - 2.0f / 16;
	...
	public override void render()
	{
		...
		if (outline != 0)
			Renderer.DrawVerticalOutline(position.x - 0.5f, position.y, 0, 1, 1, 0, sprite, false, outline);
