...
public class Coin : Entity
{
	...
	public override void update()
	{
		...
		if (target == null)
		{
			velocity = Vector2.Lerp(velocity, Vector2.Zero, 5 * Time.deltaTime);
	...
	public override void render()
	{
		...
		Renderer.DrawVerticalSprite(position.x - 1 / 16.0f, position.y, 0, 2 / 16.0f, 2 / 16.0f, null, false, 0, color * new Vector4(brightness, brightness, brightness, 1));
	}
}
