...
public class GameState : State
{
	...
	public override void init()
	{
		...
		*/
		...
		scene.addEntity(new ItemEntity(new Dagger()), new Vector3(5, 1.5f, 0));
		scene.addEntity(new ItemEntity(new Spear()), new Vector3(6, 1.5f, 0));
		scene.addEntity(new ItemEntity(new Torch()), new Vector3(7, 1.5f, 0));

		scene.addEntity(new Ogre(), new Vector3(2, 0, -2));

		//Entity clothPlayer;
		//scene.addEntity(clothPlayer = new Player2(), new Vector3(0, 1, -1));
