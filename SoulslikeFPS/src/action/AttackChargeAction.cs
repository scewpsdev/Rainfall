...
public class AttackChargeAction : FirstPersonAction
{
	Weapon weapon;
	AttackData attack;
	...
	public override void update(Player player)
	{
		...
		if (!input.isDown())
		{
			player.actionManager.queueAction(new AttackAction(weapon, attack, hand, Mathf.Remap(elapsedTime, followUpCancelTime, duration, 0, 1)));
			attackQueued = true;
		}
	}
}
