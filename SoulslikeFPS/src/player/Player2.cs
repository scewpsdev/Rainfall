...
public class Player2 : Entity
{
	...
	public override void init()
	{
		...
		scene.addEntity(cloth = new ClothEntity(Resource.GetModel("entity/creature/generic_dude2_cloth.gltf"), 0, animator, clothParams), position, rotation * Quaternion.AxisAngle(Vector3.Up, MathF.PI));
		cloth.setSpheres(
	...
	public override void fixedUpdate(float delta)
	{
		...
		cloth.rotation = rotation * Quaternion.AxisAngle(Vector3.Up, MathF.PI);
	}
