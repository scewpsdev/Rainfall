...
public class PlayerAction
{
	...
	public virtual void update(Player2 mob)
	{
	...
	public virtual void onQueued(Player2 player)
	{
	}

	public virtual void onStarted(Player2 player)
	{
	}

	public virtual void onFinished(Player2 player)
	{
	}
