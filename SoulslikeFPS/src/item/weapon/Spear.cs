...
public class Spear : Weapon
{
		...
		: base("spear", "Spear")
	{
		...
		addAttack(new AttackData("attack1", "attack1", new Vector2i(13, 22), 28, "attack2", "heavy2", DamageType.Thrust));
		addAttack(new AttackData("attack2", "attack2", new Vector2i(13, 22), 28, "attack1", "heavy1", DamageType.Thrust));
