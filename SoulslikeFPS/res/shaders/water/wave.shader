...
void animateWater(vec2 p, float t, int numWaves, float amplitude, float frequency, out vec3 outPosition, out vec3 outNormal)
{
	...
	{
		float waveSpeed = (1.0 + sin(i * 34871) * 0.2) * 1;
