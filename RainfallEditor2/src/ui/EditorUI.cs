...
public static unsafe partial class EditorUI
{
	...
	static unsafe void MenuBar(RainfallEditor2 editor)
	{
	...
	static unsafe void TabPane(RainfallEditor2 editor)
	{
	...
	public static void Draw(RainfallEditor2 editor)
	{
		MenuBar(editor);
		TabPane(editor);
		if (editor.currentTab != null)
