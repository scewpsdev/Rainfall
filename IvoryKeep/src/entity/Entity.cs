...
public class Entity
{
	...
	{
		return Matrix.CreateTransform(new Vector3(position + offset, z), Quaternion.AxisAngle(Vector3.UnitZ, rotation));
	}

	public Vector2 center => collider != null ? position + collider.center : position;
}
