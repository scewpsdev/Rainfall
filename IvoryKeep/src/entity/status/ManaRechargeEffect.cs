...
public class ManaRechargeEffect : StatusEffect
{
	...
	public override unsafe void init(Entity entity)
	{
		...
		effect.systems[0].handle->colorAnim.value0.value.xyz = Mathf.ARGBToVector(0xFF758FFF).xyz;
		effect.systems[0].handle->colorAnim.value1.value.xyz = Mathf.ARGBToVector(0xFF758FFF).xyz;
