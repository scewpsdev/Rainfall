...
public class ParallaxObject : Entity
{
	...
	public override void render()
	{
		...
		//Renderer.DrawSpriteSolid(vertex.x + rect.min.x, vertex.y + rect.min.y, z + 0.01f, rect.size.x, rect.size.y, 0, sprite, false, Mathf.VectorToARGB(new Vector4(GameState.instance.level.fogColor, 1 - fog)));
