...
public class Stalker : Mob
{
	...
	void renderLeg(Vector2 origin, Vector2 pos, float length0, float length1, int kneeDirection)
	{
		...
		Renderer.DrawLine(new Vector3(origin, 0), new Vector3(jointPosition, 0), Mathf.ARGBToVector(0xFF444444));
		Renderer.DrawLine(new Vector3(jointPosition, 0), new Vector3(pos, 0), Mathf.ARGBToVector(0xFF444444));
	}
