...
public class StartingClass
{
	...
	{
		barbarian = new StartingClass() { name = "Barbarian", color = 0xFFa13d3b, cost = 12, items = [new LeatherArmor(), new Handaxe(), new BerserkersChain()], hp = 8, magic = 2, strength = 2 };
		knight = new StartingClass() { name = "Knight", color = 0xFF7582ae, cost = 12, items = [new Shortsword(), new WoodenShield(), new ChainmailHood(), new ChainmailArmor()], hp = 7, magic = 3 };
		hunter = new StartingClass() { name = "Hunter", color = 0xFF6c8c50, cost = 12, items = [new Shortbow(), /*new Arrow() { stackSize = 50 }, */new HuntersHat(), new EaglesEye()], hp = 6, magic = 4 };
		thief = new StartingClass() { name = "Thief", color = 0xFF676767, cost = 12, items = [new Dagger(), new DarkHood(), new DarkCloak(), (new GreenPotion() { stackSize = 3 }).makeThrowable(), new ThrowingKnife() { stackSize = 5 }, new Parsley(), new Nightstalker()], hp = 5, magic = 4, dexterity = 2 };
