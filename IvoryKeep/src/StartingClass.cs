...
public class StartingClass
{
	...
	static StartingClass()
	{
		...
		wizard = new StartingClass() { name = "Wizard", color = 0xFF73549d, cost = 8, items = [new MagicStaff(), new MagicArrowSpell(), new WizardHat(), new WizardsCloak(), new WizardsLegacy()], magic = 6 };
