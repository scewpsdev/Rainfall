...
public class CavesPlatformingRoom1 : Entity
{
	Room room;
	LevelGenerator generator;

	public CavesPlatformingRoom1(Room room, LevelGenerator generator)
	{
		this.room = room;
	...
	public override void init(Level level)
	{
		...
		generator.spawnChest(chestPosition.x, chestPosition.y, generator.getRoomLootValue(room) * 5);
