...
public class PlayerActionManager
{
	...
	public PlayerActionManager(Player player, Node rootMotionNode)
	{
		this.player = player;
	...
	void initializeAction(PlayerAction currentAction)
	{
		...
		{
			Model animationDataScene = currentAction.animationData != null ? currentAction.animationData : player.model;
			animationData = animationDataScene.getAnimationData(currentAction.animationName);
			anim.layers[0].animationData = animationDataScene;
		}
