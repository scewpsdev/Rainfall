...
public class Trampoline : Entity
{
	...
	public override void update()
	{
		...
		int numHits = GameState.instance.level.overlap(position + new Vector2(-0.5f, 0), position + new Vector2(0.5f, 0.25f), hits, FILTER_PROJECTILE | FILTER_MOB | FILTER_PLAYER | FILTER_ITEM | FILTER_DECORATION);
