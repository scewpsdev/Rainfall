...
cd bin\Release\net8.0\publish
tar -a -cf ..\roguep-0.1.10a.zip *
move ..\roguep-0.1.10a.zip .

:: xcopy /y /e /q .\ ..\..\..\..\builds\0.1.10a\
mkdir ..\..\..\..\builds\0.1.10a\
xcopy /y roguep-0.1.10a.zip ..\..\..\..\builds\0.1.10a\

butler push roguep-0.1.10a.zip scewps/ivory-keep:0.1.10a-windows --userversion=0.1.10a
