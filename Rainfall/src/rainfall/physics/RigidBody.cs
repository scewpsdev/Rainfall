...
namespace Rainfall
{
	...
	public unsafe class RigidBody
	{
		...
		{
			Physics.Physics_RigidBodySetActive(body, (byte)(active ? 1 : 0));
		}
		...
		{
			Physics.Physics_RigidBodyScale(body, scale);
		}
		...
		public void getWorldAABB(out Vector3 position, out Vector3 size)
		{
			Physics.Physics_RigidBodyGetWorldAABB(body, out position, out size);
		}
