...
namespace Rainfall
{
	...
	public struct Quaternion
	{
		...
		public Vector4 axisAngle => new Vector4(axis, angle);
		...
		*/
		...
		{
			return AxisAngle(Vector3.UnitY, eulers.y) * AxisAngle(Vector3.UnitX, eulers.x) * AxisAngle(Vector3.UnitZ, eulers.z);
		}
		...
		{
			return LookAt(Vector3.Zero, forward, Vector3.Up);
		}
