...
namespace Rainfall
{
	...
	public static class Input
	{
		...
		static bool mouseJustLocked = true;
		...
		public static bool IsKeyPressed(KeyCode key, bool consume = false)
		{
			bool result = keysCurrent.IsKeyDown(key) && !keysLast.IsKeyDown(key);
			if (result && consume)
				ConsumeKeyEvent(key);
			return result;
		}
		...
		public static Vector2i cursorPosition
		{
			...
			set
			{
				Application.Application_SetMousePosition(value.x, value.y);
			}
		}
