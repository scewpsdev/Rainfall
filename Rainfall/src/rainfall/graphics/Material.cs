...
namespace Rainfall
{
	public class Material
	{
		...
		public static Material CreateDeferred(uint color = 0xFFFFFFFF, float metallicFactor = 0.0f, float roughnessFactor = 1.0f, Vector3 emissiveColor = default, float emissiveStrength = 0.0f, Texture diffuse = null, Texture normal = null, Texture roughness = null, Texture metallic = null, Texture emissive = null, Texture height = null)
		{
			IntPtr handle = Material_CreateDeferred(color, metallicFactor, roughnessFactor, emissiveColor, emissiveStrength,
		...
		public static Material CreateForward(uint color = 0xFFFFFFFF, float metallicFactor = 0.0f, float roughnessFactor = 1.0f, Vector3 emissiveColor = default, float emissiveStrength = 0.0f, Texture diffuse = null, Texture normal = null, Texture roughness = null, Texture metallic = null, Texture emissive = null, Texture height = null)
		{
			IntPtr handle = Material_Create(IntPtr.Zero, 1, Mathf.ARGBToVector(color), new Vector4(roughnessFactor, metallicFactor, 0, 0), new Vector4(emissiveColor, emissiveStrength), Vector4.Zero,
				diffuse != null ? diffuse.handle : ushort.MaxValue,
				normal != null ? normal.handle : ushort.MaxValue,
				roughness != null ? roughness.handle : ushort.MaxValue,
				metallic != null ? metallic.handle : ushort.MaxValue,
		...
		public static Material Create(Shader shader, bool isForward = false, Vector4 data0 = default, Vector4 data1 = default, Vector4 data2 = default, Vector4 data3 = default, Texture texture0 = null, Texture texture1 = null, Texture texture2 = null, Texture texture3 = null, Texture texture4 = null, Texture texture5 = null)
		{
			IntPtr handle = Material_Create(shader != null ? shader.handle : IntPtr.Zero, (byte)(isForward ? 1 : 0),
		...
		public void copyData(IntPtr from)
		{
			Material_CopyData(handle, from);
		}
		...
		[DllImport(Native.Native.DllName, CallingConvention = CallingConvention.Cdecl)]
		static extern unsafe void Material_CopyData(IntPtr handle, IntPtr from);
