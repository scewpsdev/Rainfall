...
public class PixelEngine2 : Game
{
	...
	public static new PixelEngine2 instance { get => (PixelEngine2)Game.instance; }
	static readonly string ASSEMBLY_NAME = Assembly.GetAssembly(typeof(PixelEngine2))?.GetName().Name;
