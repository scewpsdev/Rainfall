...
public class Modifier
{
	...
	public void render(Entity entity)
	{
		if (renderAura)
		{
			...
			Renderer.DrawSprite(center.x - 0.5f * size, center.y - 0.5f * size, Entity.LAYER_BG, size, size, 0, aura, false, MathHelper.ARGBToVector(color) * new Vector4(alpha, alpha, alpha, 1), true);
		}
	}
}
