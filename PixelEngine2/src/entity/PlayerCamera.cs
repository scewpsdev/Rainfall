...
public class PlayerCamera : Entity
{
	...
	{
		width = PixelEngine2.instance.width / 16.0f; // Display.width / (float)scale / 16.0f;
		height = PixelEngine2.instance.height / 16.0f; // Display.height / (float)scale / 16.0f;
	...
	{
		Matrix projection = Matrix.CreateOrthographic(width, height, -100, 100);
