...
public class TileType
{
	...
	public static TileType stone_floor;
	...
	static TileType()
	{
		...
		AddTileType(path = new TileType()
		{
			...
			sprites = [new Sprite(tileset, 3, 6), new Sprite(tileset, 3, 7), new Sprite(tileset, 3, 8), new Sprite(tileset, 4, 6), new Sprite(tileset, 4, 7), new Sprite(tileset, 4, 8), new Sprite(tileset, 5, 6), new Sprite(tileset, 5, 7), new Sprite(tileset, 5, 8)],
