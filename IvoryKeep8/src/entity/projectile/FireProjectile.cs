...
public class FireProjectile : Projectile
{
	...
	{
		GameState.instance.level.addEntity(ParticleEffects.CreateImpactEffect(normal, velocity.length, Mathf.ARGBToVector(0xFFb88865).xyz * 2), position - velocity * Time.deltaTime);
	}
}
