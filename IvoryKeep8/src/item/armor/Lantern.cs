...
public class Lantern : Item
{
	...
	{
		GameState.instance.level.addEntity(particles = new ParticleEffect(player, "effects/torch.rfs"), player.position + new Vector2(0, 0.5f));
	}
	...
	public override void render(Entity entity)
	{
		if (entity is Player && (entity as Player).isAlive)
		{
			...
			rotationVelocity = Mathf.Lerp(rotationVelocity, 0, 1 * Time.deltaTime);
