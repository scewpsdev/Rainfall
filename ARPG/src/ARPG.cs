...
public class ARPG : Game
{
	...
	public static new ARPG instance { get => (ARPG)Game.instance; }
	static readonly string ASSEMBLY_NAME = Assembly.GetAssembly(typeof(ARPG))?.GetName().Name;
