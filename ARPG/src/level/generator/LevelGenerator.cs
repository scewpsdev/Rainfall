...
public partial class LevelGenerator
{
	...
	{
		generateSingleRoomLevel(level, new Room("level/cliffside/cliffside_tilemap.png"), null, TileType.dummy, TileType.stone);

		level.fogFalloff = 0.005f;
		level.fogColor = Vector3.Zero;
	}
