...
public class PlayerCamera : Entity
{
	...
	{
		width = ARPG.instance.width / 16.0f; // Display.width / (float)scale / 16.0f;
		height = ARPG.instance.height / 16.0f; // Display.height / (float)scale / 16.0f;
	...
	public override void render()
	{
		...
		Matrix projection = Matrix.CreatePerspective(fov, Display.aspectRatio, 0.1f, 500);
		Matrix transform = getTransform(currentScreenShake, distance);
