...
internal class Roguelike : Game
{
	...
	public static new Roguelike instance { get => (Roguelike)Game.instance; }
	static readonly string ASSEMBLY_NAME = Assembly.GetAssembly(typeof(Roguelike))?.GetName().Name;
