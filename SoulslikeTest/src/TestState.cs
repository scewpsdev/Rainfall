...
public class TestState : State
{
	...
	public override unsafe void init()
	{
		...
		level.addEntity(map = EntityLoader.Load("level/test_level/test_level.rfs"));
		...
		skybox = Resource.GetCubemap("level/test_level/sky1_cubemap_equirect.png");
	}
	...
	{
		Renderer.SetCamera(camera.position, camera.rotation, camera.fov, Display.aspectRatio, camera.near, camera.far);
