...
public class PlayerCamera : Camera
{
	...
	public PlayerCamera(Player player)
	{
		...
		pitch = Mathf.ToRadians(-45);
		yaw = Mathf.ToRadians(45);
	}
	...
	public override void update()
	{
		...
		distance = Mathf.Lerp(distance, distanceDst, 6 * Time.deltaTime);
		...
		if (lockedOnTarget != null)
		{
			...
			yaw = Mathf.LerpAngle(yaw, yawDst, 3 * Time.deltaTime);
			...
			pitch = Mathf.LerpAngle(pitch, pitchDst, 1 * Time.deltaTime);
		}
		else
		{
