...
public class MobAttackAction : MobAction
{
		...
		: base("mob_attack")
	{
		...
		addSoundEffect(new ActionSfx(Resource.GetSound("item/sfx/swing.ogg"), 1.0f, (attack.damageTimeStart + attack.damageTimeEnd) / 2, true));
	}
	...
	public override void update(Mob mob)
	{
		...
		Span<PhysicsHit> hits = stackalloc PhysicsHit[256];
		int numHits = 0;
