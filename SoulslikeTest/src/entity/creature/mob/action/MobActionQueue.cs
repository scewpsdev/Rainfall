...
public class MobActionQueue
{
	...
	public MobAction currentAction { get => actionQueue.Count > 0 ? actionQueue[0] : null; }
	public int size { get => actionQueue.Count; }


	public MobActionQueue(Mob mob)
	{
		this.mob = mob;
	}

	void initializeAction(MobAction currentAction)
	{
		// Initialize action
	...
	void deinitializeAction(MobAction currentAction)
	{
