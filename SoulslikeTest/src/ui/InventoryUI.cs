...
public class InventoryUI
{
	...
	public InventoryUI(Player player)
	{
		...
		equipmentHandRight = Resource.GetTexture("texture/ui/equipment_hand_right.png");
		equipmentHandLeft = Resource.GetTexture("texture/ui/equipment_hand_left.png");
		equipmentArmorHelmet = Resource.GetTexture("texture/ui/equipment_armor_helmet.png");
		equipmentArmorTorso = Resource.GetTexture("texture/ui/equipment_armor_torso.png");
		equipmentArmorPants = Resource.GetTexture("texture/ui/equipment_armor_pants.png");
		equipmentArmorBoots = Resource.GetTexture("texture/ui/equipment_armor_boots.png");
		equipmentHotbarItem = Resource.GetTexture("texture/ui/equipment_hotbar_item.png");
		equipmentArrows = Resource.GetTexture("texture/ui/equipment_arrows.png");
		equipmentSpells = Resource.GetTexture("texture/ui/equipment_spells.png");
