...
{
	const float STAMINA_REGEN_RATE = 10.0f;
	...
	public void update()
	{
		if (player.moveMode == MoveMode.Sprint && player.isGrounded && staminaPenaltyTimer == -1.0f)
		{
