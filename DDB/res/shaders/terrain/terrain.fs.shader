...
void main()
{
	...
	color.rgb = (1.0 - (splatValue.r + splatValue.g + splatValue.b)) * SRGBToLinear(vec3(173 / 255.0, 173 / 255.0, 173 / 255.0));
	color.rgb = mix(color.rgb, SRGBToLinear(vec3(115 / 255.0, 173 / 255.0, 69 / 255.0)), splatValue.r);
	color.rgb = mix(color.rgb, SRGBToLinear(vec3(219 / 255.0, 209 / 255.0, 164 / 255.0)), splatValue.g);
	color.rgb = mix(color.rgb, SRGBToLinear(vec3(114 / 255.0, 82 / 255.0, 60 / 255.0)), splatValue.b);
