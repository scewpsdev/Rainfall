...
internal class DemoScene : Room
{
	...
	public DemoScene(RoomType type, Level level)
		: base(type, Matrix.Identity, level)
	{
	...
	public override void spawn(Level level, LevelGenerator generator, Random random)
	{
		...
		addEntity(new ReverbZone(new Vector3(9.0f, 9.5f, 9.0f) * 2, true), new Vector3(0, 25.5f, -58) - new Vector3(9.0f, 9.5f, 9.0f), Quaternion.Identity);
