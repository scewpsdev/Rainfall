...
public static class Particles
{
	public static ParticleSystem CreateFire(int maxParticles, Vector3 offset = default)
	{
		...
		particles.sizeAnim = new Gradient<float>(0.02f, 0.005f);
		//particles.startVelocity= Vector3.Zero;
		particles.gravity = 1.0f;
		particles.follow = true;
		particles.additive = true;
		particles.color = new Vector4(2.7738395f, 0.7894696f, 0.25998735f, 1.0f) * 0.5f;
