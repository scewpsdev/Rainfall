...
public class ParallaxRenderer : Game
{
	...
	public static new ParallaxRenderer instance { get => (ParallaxRenderer)Game.instance; }
	static readonly string ASSEMBLY_NAME = Assembly.GetAssembly(typeof(ParallaxRenderer))?.GetName().Name;


	const int idealScale = 6;
	public int scale;
	...
	public static void Main(string[] args)
	{
		...
		Game game = new ParallaxRenderer();
