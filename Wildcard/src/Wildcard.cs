...
public class Wildcard : Game
{
	...
	public static new Wildcard instance { get => (Wildcard)Game.instance; }
	static readonly string ASSEMBLY_NAME = Assembly.GetAssembly(typeof(Wildcard))?.GetName().Name;
