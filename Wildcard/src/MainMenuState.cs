		...
		if (selection != -1)
		{
			switch (selection)
			{
				...
				case 1: // Daily Run
					...
					Wildcard.instance.pushState(new GameState());
					break;
...
#if DEBUG
		string versionStr = $"Test Build {Wildcard.VERSION_MAJOR}.{Wildcard.VERSION_MINOR}.{Wildcard.VERSION_PATCH}{Wildcard.VERSION_SUFFIX} DEBUG";
#else
