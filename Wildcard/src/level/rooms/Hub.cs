...
public class Hub : Entity
{
	...
	{
		level.addEntity(level.entrance = new LevelTransition(GameState.instance.world.cliffside, GameState.instance.world.cliffside.exit, new Vector2i(1, 2), Vector2i.Left), new Vector2(-1, 29));
		...
		{
			TravellingMerchant gatekeeper = new TravellingMerchant(null, level, 20);
