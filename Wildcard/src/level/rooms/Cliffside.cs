...
public class Cliffside : Entity
{
	...
	public override void init(Level level)
	{
		...
		level.addEntity(level.exit = new LevelTransition(GameState.instance.world.hub, GameState.instance.world.hub.entrance, new Vector2i(2, 2), Vector2i.Right), new Vector2(room.width, 38));
