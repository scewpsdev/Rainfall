...
public class IntroBridge : Entity
{
	...
	{
		LevelTransition transition = new LevelTransition(GameState.instance.world.cliffside, null, new Vector2i(45, 2), Vector2i.Down) { destinationPosition = GameState.instance.world.cliffside.rooms[0].getMarker(0x22) };
